...
export function calculateGame(scores, rules = DEFAULT_RULES) {
  ...
  return {
    complete: true,
    valid: difference === 0 && multiplesOf100 && Math.abs(finalTotal) < 0.000001,
    scoreTotal,
    difference,
    multiplesOf100,
    finalTotal,
